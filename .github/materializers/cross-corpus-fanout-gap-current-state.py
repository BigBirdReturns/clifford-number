...
old_narrative = (
    ...
    "The current committed crawl exposes two source gaps: SAM.gov did not execute because its credential is unavailable, and the Federal Register run is partial because one configured query returned an upstream 503 while eleven records were still observed. "
...
lane["what_the_data_shows"] = (
    ...
    "The Federal Register source completed successfully in the current crawl and is no longer represented as an active coverage gap. "
    "The remaining SAM state supports neither a zero-result interpretation nor evidence of absence."
)
public_map["generated_at"] = "2026-08-22"
