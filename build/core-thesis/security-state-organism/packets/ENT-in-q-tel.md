# In-Q-Tel, Inc. evidence lane

- Package: `ENT-in-q-tel`
- Class: `entity`
...
What exact legal, financial, technical, personnel, public-gate, deployment, consequence, and residual-rights records establish or falsify In-Q-Tel, Inc.'s proposed organ functions?
...
- portfolio, agency relationship, work-program, IP, pilot, follow-on procurement, and non-invested comparator records
...
IQT investment proves agency control, deployment, or classification of the recipient company. The proposed function or link remains unproved unless the required records independently close it.
