# Venture Capital Corporate Control Estate full-organism review

- Package: `EST-venture-capital-corporate-control-estate`
- Class: `estate`
- Priority: `unranked`
...
No evidence-strength or execution priority is assigned by registry density.

## Proof question

Does this estate supply independently receipted organs, lineage transitions, transfers, consequences, counterpower results, or falsifiers for the organism thesis?

## Explicit targets

- Estate: `venture-capital-corporate-control-estate` — Venture Capital Corporate Control Estate
- Entity: `alex-karp` — Alex Karp
- Entity: `alias-a17` — a17
- Entity: `alias-bvc` — BVC
- Entity: `american-dynamism` — American Dynamism
- Entity: `andreessen-horowitz` — Andreessen Horowitz / a16z
- Entity: `anduril-industries-inc` — Anduril Industries, Inc.
- Entity: `brian-schimpf` — Brian Schimpf
- Entity: `eight-partners-vc-llc` — Eight Partners VC, LLC / 8VC
- Entity: `erebor-bank-na` — Erebor Bank, National Association
- Entity: `founders-fund` — Founders Fund
- Entity: `idf-unit-8200` — Israel Defense Forces Unit 8200
- Entity: `in-q-tel` — In-Q-Tel, Inc.
- Entity: `joe-lonsdale` — Joe Lonsdale
- Entity: `lux-capital` — Lux Capital
- Entity: `natsec100` — NatSec100
- Entity: `palantir-technologies-inc` — Palantir Technologies Inc.
- Entity: `palmer-luckey` — Palmer Luckey
- Entity: `peter-thiel` — Peter Thiel
- Entity: `silent-capital` — Silent Capital
...
- Entity: `spacexai` — SpaceXAI / historical X.AI Corp.
- Entity: `tesla-inc` — Tesla, Inc.
- Entity: `the-boring-company` — The Boring Company
- Entity: `trae-stephens` — Trae Stephens
- Entity: `traysar-inc` — Traysar, Inc.
- Entity: `traysar-industries-ltd` — Traysar Industries Ltd.
...
- Organ: `O2-convening` — Convening and policy translation
- Organ: `O3-capital` — Capital and company formation
- Organ: `O4-banking` — Banking and financial rails
- Organ: `O5-identity-data` — Identity, data, and ontology
- Organ: `O6-sensing` — Persistent sensing and surveillance
- Organ: `O7-comms-compute` — Communications, space, compute, and models
...
- `SPACEXAI-OFFICIAL` — SPACEXAI OFFICIAL · `source_bounded_locator` · https://x.ai/news/xai-joins-spacex
- `SVDG-OFFICIAL` — SVDG OFFICIAL · `candidate_first_party_locator` · https://www.svdg.org/
- `TESLA-OFFICIAL` — TESLA OFFICIAL · `candidate_first_party_locator` · https://www.tesla.com/
...
- `US-ENERGY-ENVIRONMENT` — US ENERGY ENVIRONMENT · `unresolved_locator` · locator unresolved
