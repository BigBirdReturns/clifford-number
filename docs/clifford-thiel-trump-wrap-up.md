# Clifford game trail: the board, not a verdict

This artifact is a discovery surface. It does not tell the player what to
conclude.
...
control the Clifford Number. They do not control what the discovery board is
allowed to show.
...
- Sanabil is reported as PIF-owned and publicly lists Founders Fund as a fund
  ...
  rights remain open; the visible structural trail remains on the board.
...
question for the player—not a verdict supplied by the repository.
...
not make the convening ecology disappear. The playable move is to find the
