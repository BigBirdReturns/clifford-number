...
const mutations = [
  ...
  ['widen MT-003 source beyond frozen targets', (p) => { p.source.decisions.find((d) => d.route_id === 'RD04-W03-PPN-MT-003').candidate_fields_for_offline_review.push('operative_state_implementation_authority_and_version'); }],
  ...
  ['reuse MT-003 outside its frozen field targets', (p) => { p.field.decisions.find((d) => d.decision_id === 'RD04-PPN-MT-OPERATIVE-STATE-IMPLEMENTATION-AUTHORITY-AND-VERSION').source_route_ids.push('RD04-W03-PPN-MT-003'); }],
