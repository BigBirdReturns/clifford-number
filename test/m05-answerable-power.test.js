...
assert.equal(report.counts.stories,14);
assert.equal(report.counts.lanes,17);
...
assert.equal(report.counts.constitutional_mechanism,4);
...
for(const id of ['M05-S01','M05-S02','M05-S03','M05-S04','M05-S05','M05-S06','M05-S10','M05-S12','M05-S13','M05-S14'])assert.ok(ids.has(id),id);
