...
import { deriveRegistry } from '../tools/build-counter-selector-wave-14.mjs';
import { validateRegistryObject } from '../tools/validate-counter-selector-wave-14.mjs';

const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
const contract = JSON.parse(fs.readFileSync(path.join(root, 'data/project/counter-selector-wave-14-blind-review.json'), 'utf8'));
...
console.log(`counter-selector-wave-14.test: PASS (${passed} adversarial mutations)`);
