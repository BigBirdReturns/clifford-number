...
test('mixed boundaries remain explicit instead of falsifying freshness', () => {
  assert.equal(boundary.alignment.mixed_projection_boundaries, graph.generated !== surfaces.generated);
