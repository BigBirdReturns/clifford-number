...
compile(s,'<rd04-nd-current-gap-promotion-validation-v4>','exec')
exec(compile(s,'<rd04-nd-current-gap-promotion-validation-v4>','exec'),{'__name__':'__main__','__file__':__file__})
