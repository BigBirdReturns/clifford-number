...
export const C = Object.freeze({
  ...
  INPUT_BYTES: 6188,
  INPUT_SHA: 'bbe6686933dbd5168db6004cbd87c3d29c63a5654cea2688c0dc04deb600bed6',
  INPUT_BLOB: '6db95aa4c3c3edc1f9848b2a1347846054cc8765',
  ...
  PROMOTED_MATRIX_SHA: '9f9dc05a057396056771bb566c44e9c3779d8ef6b0d2c078f7ffff11d9c7e6cb',
  PROMOTED_MATRIX_BLOB: '6ba11a6025021e9df8ac6535be8c42499654c233',
...
function validateInputs(inputBytes, input, decisionBytes, decision) {
  ...
  assert(input.projection.promoted_matrix_git_blob === C.PROMOTED_MATRIX_BLOB, 'input projection promoted matrix Git blob mismatch');
  const prior = input.prior_candidate_validation;
  assert(prior.pull_request === C.PRIOR_VALIDATION_PR && prior.product_commit === '0de57f1d6d395e28e495b456794fe92b681a35c6' && prior.product_tree === 'fef73cc4267070c8cc7fb7c1dc15481477391d62' && prior.merge_commit === '789c800d00a6d4924cb69d2ce33d336ab315972f', 'prior validation venue mismatch');
...
export function buildModel(repoRoot=process.cwd(), overrides=new Map()) {
  ...
  promoted.postpromotion_nd_current_public_record_gap_row_state_reconciliation_product={
    ...
    validation_repair_product_commit:'0de57f1d6d395e28e495b456794fe92b681a35c6',validation_repair_product_tree:'fef73cc4267070c8cc7fb7c1dc15481477391d62',validation_repair_merge_commit:'789c800d00a6d4924cb69d2ce33d336ab315972f',
