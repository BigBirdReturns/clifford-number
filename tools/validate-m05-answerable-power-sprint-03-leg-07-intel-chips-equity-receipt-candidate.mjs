...
const boundObjects=[
  ...
  ['robodebt_pre_action_implementation_receipt',robodebtReceiptRaw,robodebtReceipt]
];
...
if(JSON.stringify(robodebtReceipt)!==before.robodebtReceipt)fail('Intel validation mutated the Robodebt implementation receipt');
