...
import {
  compilePreferenceCustodyManifestV20,
  renderPreferenceCustodyManifestV20Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v20.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v20.md';
...
const architectureBuild = compilePreferenceChoiceArchitectureFixture(readJson('data/research/preference-custody/choice-architecture.fixture.json'));
const compiled = compilePreferenceCustodyManifestV20(readJson(manifestPath), baseV19, architectureBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV20Markdown(compiled));
