...
import {
  compilePreferenceCustodyManifestV29,
  renderPreferenceCustodyManifestV29Markdown
} from './lib/preference-custody-manifest-v29.mjs';

const manifestPath = process.argv[2] ?? 'data/research/preference-custody/control-manifest-v29.json';
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v29.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v29.md';
...
const compiled = compilePreferenceCustodyManifestV29(readJson(manifestPath), baseV28, serviceDenominatorBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV29Markdown(compiled));
