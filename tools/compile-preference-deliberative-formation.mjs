...
const jsonPath = process.argv[3] ?? 'build/research/preference-deliberative-formation.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-deliberative-formation.md';
...
writeFileSync(markdownPath, renderPreferenceDeliberativeFormationMarkdown(compiled));
