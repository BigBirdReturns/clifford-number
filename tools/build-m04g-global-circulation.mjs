...
const sourceHealthPolicy = read('data/project/m04g-global-circulation-source-health-policy.json');
const hash = crypto.createHash('sha256').update(JSON.stringify({
  methodology,
  basins:basinsDoc.basins,
  currents:currentsDoc.currents,
  sources:sourcesDoc.sources,
  polls:pollsDoc.polls,
  lanes:fanoutDoc.lanes,
...
const report = {
  schema:'m04g-global-circulation-report@2',
  ...
  source_health_policy:{
    schema_version:sourceHealthPolicy.schema_version,
    request_policy:sourceHealthPolicy.request_policy,
    host_policy:sourceHealthPolicy.host_policy,
    failure_taxonomy:sourceHealthPolicy.failure_taxonomy,
    health_states:sourceHealthPolicy.health_states,
    acceptance_contract:sourceHealthPolicy.acceptance_contract,
    baseline:sourceHealthPolicy.baseline,
    boundaries:sourceHealthPolicy.boundaries
  },
  basins:basinRows,
  currents:currentsDoc.currents,
