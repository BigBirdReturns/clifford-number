...
import {
  compilePreferenceCustodyManifestV21,
  renderPreferenceCustodyManifestV21Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v21.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v21.md';
...
const assuranceBuild = compilePreferenceComprehensionAssuranceFixture(readJson('data/research/preference-custody/comprehension-assurance.fixture.json'));
const compiled = compilePreferenceCustodyManifestV21(readJson(manifestPath), baseV20, assuranceBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV21Markdown(compiled));
