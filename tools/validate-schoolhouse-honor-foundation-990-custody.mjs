...
export function validateSchoolhouseHonorFoundation990Custody(dir = DEFAULT_DIR) {
  ...
  check(manifest.counts.source_inventory_rows === 482 && manifest.counts.coverage_denominator_rows === 31 && manifest.counts.explicit_gap_rows === 16, 'Form 990 manifest headline denominator drift');
  check(manifest.source_inventory.evidence_class_counts.official === 257 && manifest.source_inventory.evidence_class_counts.primary_public === 54 && manifest.source_inventory.evidence_class_counts.primary_public_state_charity_registry_route_custody === 6, 'Form 990 manifest provenance count drift');
