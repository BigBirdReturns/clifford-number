...
import {
  compilePreferenceCustodyManifestV17,
  renderPreferenceCustodyManifestV17Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v17.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v17.md';
...
const allocationBuild = compilePreferenceAllocationFormulaFixture(readJson('data/research/preference-custody/allocation-formula.fixture.json'));
const compiled = compilePreferenceCustodyManifestV17(readJson(manifestPath), baseV16, allocationBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV17Markdown(compiled));
