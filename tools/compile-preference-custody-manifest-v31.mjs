...
import { compilePreferenceCustodyManifestV31, renderPreferenceCustodyManifestV31Markdown } from './lib/preference-custody-manifest-v31.mjs';
...
const compiled = compilePreferenceCustodyManifestV31(readJson(manifestPath), baseV30, eligibilityOutreachBuild);
