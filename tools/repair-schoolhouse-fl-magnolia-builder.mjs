...
if (nestedBackticks === 0 || nestedBackticks % 2 !== 0) {
  throw new Error(`nested validator backticks must be a positive even count, found ${nestedBackticks}`);
}
block = block
  .replaceAll('`', '\\`')
...
console.log(JSON.stringify({
  ...
  repair_order: 'semantic_repair_then_template_escape',
