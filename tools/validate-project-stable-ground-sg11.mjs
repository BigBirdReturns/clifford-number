...
export function validateSg11(context = loadSg11Context()) {
  ...
  eq(trigger.integration_base, '2155844efb5867f60013711fe8647a6a7f938604', 'SG-11 integration base');
  eq(trigger.integration_commit, 'c71d3bc6fce9e30626304f5fdf0ea5f4f6214d40', 'SG-11 integration commit');
  eq(trigger.integration_tree, '2290a5fceed74b9bd9e594755cfc0e9733da3893', 'SG-11 integration tree');
