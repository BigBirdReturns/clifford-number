...
export function validateSg11(context = loadSg11Context()) {
  ...
  eq(trigger.integration_base, '2362f4357bf58d388dad11f38bcac62f580ce89b', 'SG-11 integration base');
  eq(trigger.integration_commit, '4a0cf108098789f93732b829fc5a5e4ea152f28b', 'SG-11 integration commit');
  eq(trigger.integration_tree, 'e2c1964d853714a7ca34cde57272588e3e4b611e', 'SG-11 integration tree');
