...
import {
  compilePreferenceCustodyManifestV18,
  renderPreferenceCustodyManifestV18Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v18.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v18.md';
...
const releaseBuild = compilePreferenceReleaseAuthorityFixture(readJson('data/research/preference-custody/release-authority.fixture.json'));
const compiled = compilePreferenceCustodyManifestV18(readJson(manifestPath), baseV17, releaseBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV18Markdown(compiled));
