...
import {
  compilePreferenceCustodyManifestV23,
  renderPreferenceCustodyManifestV23Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v23.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v23.md';
...
const criterionBuild = compilePreferenceCriterionScoreUseFixture(readJson('data/research/preference-custody/criterion-score-use.fixture.json'));
const compiled = compilePreferenceCustodyManifestV23(readJson(manifestPath), baseV22, criterionBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV23Markdown(compiled));
