...
function defaultTransitionVerifier(checkpoint) {
  ...
  if (ancestry.status !== 0) {
    // A shallow PR checkout can contain the transition and declared base as
    // separately acquired commit objects without enough graph depth for
    // merge-base. The immutable commit object still names its direct parent.
