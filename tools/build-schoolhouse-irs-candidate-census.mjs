...
if (adjudication.route_denominator.source_rows_scanned !== 4428541) fail(`IRS scanned-row count drift: ${adjudication.route_denominator.source_rows_scanned}`);
