...
import { compileFixture, renderMarkdown } from './lib/preference-linkage-repository-owner-login-normalization-alias-case-location-pair-assurance.mjs';
...
const jsonPath=process.argv[3]??'build/research/preference-linkage-repository-owner-login-normalization-alias-case-location-pair-assurance.json';
const markdownPath=process.argv[4]??'build/research/preference-linkage-repository-owner-login-normalization-alias-case-location-pair-assurance.md';
...
let build; try { build=compileFixture(fixture); } catch(e) { console.error(`- PC-60 deterministic compile failed: ${e.message}`); process.exit(1); }
