...
import {
  compilePreferenceCustodyManifestV22,
  renderPreferenceCustodyManifestV22Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v22.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v22.md';
...
const validityBuild = compilePreferenceInstrumentValidityFixture(readJson('data/research/preference-custody/instrument-validity.fixture.json'));
const compiled = compilePreferenceCustodyManifestV22(readJson(manifestPath), baseV21, validityBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV22Markdown(compiled));
