...
import {
  compilePreferenceCustodyManifestV25,
  renderPreferenceCustodyManifestV25Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v25.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v25.md';
...
const compiled = compilePreferenceCustodyManifestV25(readJson(manifestPath), baseV24, interferenceBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV25Markdown(compiled));
