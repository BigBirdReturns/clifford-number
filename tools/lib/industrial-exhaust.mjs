...
function trailingObservationGroup(candidate, groups, externalPrefix, externalSuffix) {
  ...
  const normalizedCandidate = candidate.normalize('NFKC').trimStart();
