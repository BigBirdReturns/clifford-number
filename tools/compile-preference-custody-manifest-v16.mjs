...
import {
  compilePreferenceCustodyManifestV16,
  renderPreferenceCustodyManifestV16Markdown
...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v16.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v16.md';
...
const distributionBuild = compilePreferenceCollectiveDistributionFixture(readJson('data/research/preference-custody/collective-distribution.fixture.json'));
const compiled = compilePreferenceCustodyManifestV16(readJson(manifestPath), baseV15, distributionBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV16Markdown(compiled));
