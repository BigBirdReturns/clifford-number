...
import { compilePreferenceInterferenceMappingFixture } from './lib/preference-interference-mapping.mjs';
import { compilePreferenceTopologyAssuranceFixture } from './lib/preference-topology-assurance.mjs';
import { compilePreferenceEquilibriumAssuranceFixture } from './lib/preference-equilibrium-assurance.mjs';
import { compilePreferenceMarketServiceAssuranceFixture } from './lib/preference-market-service-assurance.mjs';
import { compilePreferenceServiceDenominatorAssuranceFixture } from './lib/preference-service-denominator-assurance.mjs';
import { compilePreferencePreIntakeAssuranceFixture } from './lib/preference-pre-intake-assurance.mjs';
import { compilePreferenceEligibilityOutreachAssuranceFixture } from './lib/preference-eligibility-outreach-assurance.mjs';
...
import { compilePreferenceCustodyManifestV24 } from './lib/preference-custody-manifest-v24.mjs';
import { compilePreferenceCustodyManifestV25 } from './lib/preference-custody-manifest-v25.mjs';
import { compilePreferenceCustodyManifestV26 } from './lib/preference-custody-manifest-v26.mjs';
import { compilePreferenceCustodyManifestV27 } from './lib/preference-custody-manifest-v27.mjs';
import { compilePreferenceCustodyManifestV28 } from './lib/preference-custody-manifest-v28.mjs';
import { compilePreferenceCustodyManifestV29 } from './lib/preference-custody-manifest-v29.mjs';
import { compilePreferenceCustodyManifestV30 } from './lib/preference-custody-manifest-v30.mjs';
import { compilePreferenceCustodyManifestV31 } from './lib/preference-custody-manifest-v31.mjs';
import { compilePreferenceSourcePopulationRuleAssuranceFixture } from './lib/preference-source-population-rule-assurance.mjs';
import { compilePreferenceCustodyManifestV32, renderPreferenceCustodyManifestV32Markdown } from './lib/preference-custody-manifest-v32.mjs';

const manifestPath = process.argv[2] ?? 'data/research/preference-custody/control-manifest-v32.json';
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v32.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v32.md';
...
const baseV24 = compilePreferenceCustodyManifestV24(readJson('data/research/preference-custody/control-manifest-v24.json'), baseV23, causalBuild);
const interferenceBuild = compilePreferenceInterferenceMappingFixture(readJson('data/research/preference-custody/interference-mapping.fixture.json'));
const baseV25 = compilePreferenceCustodyManifestV25(readJson('data/research/preference-custody/control-manifest-v25.json'), baseV24, interferenceBuild);
const topologyBuild = compilePreferenceTopologyAssuranceFixture(readJson('data/research/preference-custody/topology-assurance.fixture.json'));
const baseV26 = compilePreferenceCustodyManifestV26(readJson('data/research/preference-custody/control-manifest-v26.json'), baseV25, topologyBuild);
const equilibriumBuild = compilePreferenceEquilibriumAssuranceFixture(readJson('data/research/preference-custody/equilibrium-assurance.fixture.json'));
const baseV27 = compilePreferenceCustodyManifestV27(readJson('data/research/preference-custody/control-manifest-v27.json'), baseV26, equilibriumBuild);
const marketServiceBuild = compilePreferenceMarketServiceAssuranceFixture(readJson('data/research/preference-custody/market-service-assurance.fixture.json'));
const baseV28 = compilePreferenceCustodyManifestV28(readJson('data/research/preference-custody/control-manifest-v28.json'), baseV27, marketServiceBuild);
const serviceDenominatorBuild = compilePreferenceServiceDenominatorAssuranceFixture(readJson('data/research/preference-custody/service-denominator-assurance.fixture.json'));
const baseV29 = compilePreferenceCustodyManifestV29(readJson('data/research/preference-custody/control-manifest-v29.json'), baseV28, serviceDenominatorBuild);
const preIntakeBuild = compilePreferencePreIntakeAssuranceFixture(readJson('data/research/preference-custody/pre-intake-assurance.fixture.json'));
const baseV30 = compilePreferenceCustodyManifestV30(readJson('data/research/preference-custody/control-manifest-v30.json'), baseV29, preIntakeBuild);
const eligibilityOutreachBuild = compilePreferenceEligibilityOutreachAssuranceFixture(readJson('data/research/preference-custody/eligibility-outreach-assurance.fixture.json'));
const baseV31 = compilePreferenceCustodyManifestV31(readJson('data/research/preference-custody/control-manifest-v31.json'), baseV30, eligibilityOutreachBuild);
const sourcePopulationRuleBuild = compilePreferenceSourcePopulationRuleAssuranceFixture(readJson('data/research/preference-custody/source-population-rule-assurance.fixture.json'));
const compiled = compilePreferenceCustodyManifestV32(readJson(manifestPath), baseV31, sourcePopulationRuleBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV32Markdown(compiled));
