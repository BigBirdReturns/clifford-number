...
export function validateK0({
  ...
  if (JSON.stringify(method.selection_contract?.execution_wave_ids) !== JSON.stringify(['K0-W01','K0-W02','K0-W03','K0-W04'])) fail('method execution-wave drift');
  ...
  if (report.current_result.role_neutral_universe_execution_started !== true || report.counts.role_neutral_query_executions !== 16 || report.counts.role_neutral_retained_records !== 32 || report.counts.role_neutral_candidate_records !== 16 || report.counts.role_neutral_positive_controls !== 5 || report.counts.role_neutral_negative_controls !== 5 || report.counts.role_neutral_coverage_controls !== 3 || report.counts.role_neutral_requires_additional_acquisition !== 1 || report.counts.role_neutral_resolved_additional_acquisition !== 2 || report.counts.role_neutral_wave_02_retained_records !== 7 || report.counts.role_neutral_wave_03_query_executions !== 4 || report.counts.role_neutral_wave_03_retained_records !== 7 || report.counts.role_neutral_wave_03_candidate_records !== 5 || report.counts.role_neutral_wave_04_query_executions !== 4 || report.counts.role_neutral_wave_04_retained_records !== 8 || report.counts.role_neutral_wave_04_candidate_records !== 3) fail('report role-neutral execution drift');
