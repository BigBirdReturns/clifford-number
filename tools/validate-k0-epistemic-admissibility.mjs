...
export function validateK0({
  ...
  if (neutral.status !== 'execution_started_wave_08_discovery_complete_field_adjudication_pending' || neutral.execution.name_blind_execution_started !== true || neutral.execution.searches_executed !== 52 || neutral.execution.query_templates_executed !== 9 || neutral.execution.raw_results_observed !== 302 || neutral.execution.returned_records !== 65 || neutral.execution.included_events !== 0) fail('neutral execution state drift');
  if (neutral.execution.candidate_records !== 28 || neutral.execution.positive_controls !== 14 || neutral.execution.negative_controls !== 12 || neutral.execution.coverage_controls !== 8 || neutral.execution.requires_additional_acquisition !== 3 || neutral.execution.resolved_additional_acquisition !== 2 || neutral.execution.open_additional_acquisition !== 1 || neutral.execution.non_events !== 34) fail('neutral execution classification drift');
  ...
  if (neutralWave08.schema_version !== 'k0-role-neutral-wave@1' || neutralWave08.wave_id !== 'K0-W08' || neutralWave08.records.length !== 8 || neutralWave08.excluded_result_summaries.length !== 8) fail('neutral wave-08 denominator drift');
  if (neutralWave08.counts.query_executions !== 8 || neutralWave08.counts.raw_results_observed !== 96 || neutralWave08.counts.candidate_requires_field_audit !== 4 || neutralWave08.counts.positive_controls !== 1 || neutralWave08.counts.negative_controls !== 2 || neutralWave08.counts.coverage_controls !== 1 || neutralWave08.counts.included_events !== 0) fail('neutral wave-08 count drift');
  if (neutralWave08.excluded_result_summaries.reduce((sum, row) => sum + row.excluded_after_deduplication, 0) !== 88) fail('neutral wave-08 exclusion count drift');
