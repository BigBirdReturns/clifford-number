...
export function validateK0({
  ...
  if (pendingFieldMetric?.observed !== 0 || pendingFieldMetric?.source !== 'data/research/k0-wave07-field-adjudication.json') fail('Wave 07 coverage metric drift');
