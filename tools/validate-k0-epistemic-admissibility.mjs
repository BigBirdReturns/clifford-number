...
export function validateK0({
  ...
  if (pendingFieldMetric?.observed !== 0 || pendingFieldMetric?.source !== 'data/research/k0-wave06-field-adjudication.json') fail('Wave 06 coverage metric drift');
