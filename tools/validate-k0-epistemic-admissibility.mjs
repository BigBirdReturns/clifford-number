...
export function validateK0({
  ...
  if (JSON.stringify(method.selection_contract?.execution_wave_ids) !== JSON.stringify(['K0-W01','K0-W02','K0-W03'])) fail('method execution-wave drift');
  ...
  if (neutral.status !== 'execution_started_wave_03_discovery_only' || neutral.execution.name_blind_execution_started !== true || neutral.execution.searches_executed !== 12 || neutral.execution.query_templates_executed !== 4 || neutral.execution.raw_results_observed !== 48 || neutral.execution.returned_records !== 24 || neutral.execution.included_events !== 0) fail('neutral execution state drift');
  if (neutral.execution.candidate_records !== 13 || neutral.execution.positive_controls !== 3 || neutral.execution.negative_controls !== 3 || neutral.execution.coverage_controls !== 2 || neutral.execution.requires_additional_acquisition !== 3 || neutral.execution.resolved_additional_acquisition !== 2 || neutral.execution.open_additional_acquisition !== 1 || neutral.execution.non_events !== 8) fail('neutral execution classification drift');
  if (JSON.stringify(neutral.execution.executed_wave_ids) !== JSON.stringify(['K0-W01','K0-W02','K0-W03']) || neutral.execution.independent_second_party_review_complete !== false) fail('neutral wave/independence drift');
  ...
  if (report.current_result.role_neutral_universe_execution_started !== true || report.counts.role_neutral_query_executions !== 12 || report.counts.role_neutral_retained_records !== 24 || report.counts.role_neutral_candidate_records !== 13 || report.counts.role_neutral_positive_controls !== 3 || report.counts.role_neutral_negative_controls !== 3 || report.counts.role_neutral_coverage_controls !== 2 || report.counts.role_neutral_requires_additional_acquisition !== 1 || report.counts.role_neutral_resolved_additional_acquisition !== 2 || report.counts.role_neutral_wave_02_retained_records !== 7 || report.counts.role_neutral_wave_03_query_executions !== 4 || report.counts.role_neutral_wave_03_retained_records !== 7 || report.counts.role_neutral_wave_03_candidate_records !== 5) fail('report role-neutral execution drift');
