...
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v9.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v9.md';
...
writeFileSync(markdownPath, renderPreferenceCustodyManifestV9Markdown(compiled));
