...
import { compilePreferenceCustodyManifestV30, renderPreferenceCustodyManifestV30Markdown } from './lib/preference-custody-manifest-v30.mjs';

const manifestPath = process.argv[2] ?? 'data/research/preference-custody/control-manifest-v30.json';
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v30.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v30.md';
...
const compiled = compilePreferenceCustodyManifestV30(readJson(manifestPath), baseV29, preIntakeBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV30Markdown(compiled));
