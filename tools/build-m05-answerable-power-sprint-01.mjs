...
const report={
  ...
  generated_from:[
    ...
    'data/project/m05-answerable-power-sprint-02-live-topology.json'
  ],
  counts:{
    ...
    next_sprint_lanes:topology.lanes.length,
