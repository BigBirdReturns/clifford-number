...
import {
  compilePreferenceCustodyManifestV28,
  renderPreferenceCustodyManifestV28Markdown
} from './lib/preference-custody-manifest-v28.mjs';

const manifestPath = process.argv[2] ?? 'data/research/preference-custody/control-manifest-v28.json';
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v28.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v28.md';
...
const compiled = compilePreferenceCustodyManifestV28(readJson(manifestPath), baseV27, marketServiceBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV28Markdown(compiled));
