...
export function validateWave06({
  ...
  if (neutral.status !== 'execution_started_wave_06_discovery_only') fail('aggregate neutral status drift');
  ...
  if (waveState?.status !== 'discovery_complete_field_adjudication_pending') fail('aggregate Wave 06 state drift');
