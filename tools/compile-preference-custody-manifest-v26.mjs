...
import {
  compilePreferenceCustodyManifestV26,
  renderPreferenceCustodyManifestV26Markdown
} from './lib/preference-custody-manifest-v26.mjs';

const manifestPath = process.argv[2] ?? 'data/research/preference-custody/control-manifest-v26.json';
const jsonPath = process.argv[3] ?? 'build/research/preference-custody-laboratory-floor-v26.json';
const markdownPath = process.argv[4] ?? 'build/research/preference-custody-laboratory-floor-v26.md';
...
const compiled = compilePreferenceCustodyManifestV26(readJson(manifestPath), baseV25, topologyBuild);
mkdirSync(dirname(jsonPath), { recursive: true });
mkdirSync(dirname(markdownPath), { recursive: true });
writeFileSync(jsonPath, JSON.stringify(compiled, null, 2) + '\n');
writeFileSync(markdownPath, renderPreferenceCustodyManifestV26Markdown(compiled));
