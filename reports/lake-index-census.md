...
|---|---:|---:|
| Tracked evidence-bearing files physically present | 1297 | 100.0% |
| Reachable from declared authoritative roots | 1144 | 88.2% |
| Reachable from any detected index or manifest | 1152 | 88.8% |
| Reachable from current public entry roots | 235 | 18.1% |
| Exact orphan evidence files with no inbound repository reference | 106 | 8.2% |
| Evidence files with no detected program owner | 537 | 41.4% |

## Object and receipt census

```text
distinct machine-addressable IDs:       12137
local-only identifier values observed:   1131
local-only identifier occurrences:       7863
unindexed machine-addressable IDs:      8857
divergent identifier projections:       1748
source IDs without a projection:         5034
...
```text
open pull requests observed:              19
