...
|---|---:|---:|
| Tracked evidence-bearing files physically present | 1320 | 100.0% |
| Reachable from declared authoritative roots | 1166 | 88.3% |
| Reachable from any detected index or manifest | 1174 | 88.9% |
| Reachable from current public entry roots | 240 | 18.2% |
| Exact orphan evidence files with no inbound repository reference | 106 | 8.0% |
| Evidence files with no detected program owner | 561 | 42.5% |

## Object and receipt census

```text
distinct machine-addressable IDs:       13821
local-only identifier values observed:   1131
local-only identifier occurrences:       7863
unindexed machine-addressable IDs:      8195
divergent identifier projections:       1886
...
changed paths across open pull requests:  348
