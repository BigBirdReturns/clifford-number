 ...
 * imported from `src/route-projections.js`; the canonical evidence ranking
 * remains imported from `src/evidence-rank.js`. The behavior is identical:
 * the same evidence ranking and the same year/month/day
