...
const messages = {
  en: {
    ...
    explorerIntro: 'Search people, organizations, bounded surfaces, and compiled cases—or verify a two-person connection as of a specific date.',
    topologyExplorer: 'Topology explorer', connectionChecker: 'Connection checker',
    searchLabel: 'Search person, organization, surface, or case', pressFocus: 'Press / to focus',
  ...
  es: {
    ...
    explorerIntro: 'Busca personas, organizaciones, superficies delimitadas y casos compilados, o verifica una conexión entre dos personas en una fecha concreta.',
    topologyExplorer: 'Explorador de topología', connectionChecker: 'Verificador de conexiones',
    searchLabel: 'Buscar persona, organización, superficie o caso', pressFocus: 'Pulsa / para enfocar',
  ...
  fr: {
    ...
    explorerIntro: 'Recherchez des personnes, organisations, surfaces délimitées et dossiers compilés, ou vérifiez une connexion entre deux personnes à une date précise.',
    topologyExplorer: 'Explorateur de topologie', connectionChecker: 'Vérificateur de connexions',
    searchLabel: 'Rechercher une personne, une organisation, une surface ou un dossier', pressFocus: 'Appuyez sur / pour cibler',
